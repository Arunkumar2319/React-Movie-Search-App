...
const NavBarGeneralUser = (props) => {
    ...
    useEffect(() => {
        console.log("parent sends request", props.closeProfileSettings)
    ...
    return (
        <div className='row d-flex App' >
            ...
            {/* <div className='favourites mt-3' title='Favourites' onClick={navigateToFavouritesPage}>
...
export default NavBarGeneralUser